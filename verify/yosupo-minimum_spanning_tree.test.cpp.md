...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo-minimum_spanning_tree.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/minimum_spanning_tree\"\r\n#line 2\
    ...
    \   }\n    }\n    return re;\n}\n#line 4 \"verify/yosupo-minimum_spanning_tree.test.cpp\"\
    \nint main() { IO();\r\n    int T=1;\r\n    // cin >> T;\r\n    while (T--) solve();\r\
    \n}\r\n\r\nvoid solve() {\r\n    int n, m; cin >> n >> m;\r\n    graph<ll> g(n,\
    \ false, true);\r\n    g.read(m, 0);\r\n    graph<ll> g2 = kruskal(g);\r\n   \
    \ cout << g2.sumcost << nl;\r\n    rep(i, n-1) {\r\n        cout << g2.getedge(i).id\
    \ << sp;\r\n    }\r\n    cout << nl;\r\n}\n"
  ...
  verifiedWith: []
documentation_of: verify/yosupo-minimum_spanning_tree.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo-minimum_spanning_tree.test.cpp
- /verify/verify/yosupo-minimum_spanning_tree.test.cpp.html
